...
### ⚠️ Please note, this a fork of [react-native-admob](https://github.com/sbugert/react-native-admob).
...
**npm:**
    ...
    npm i --save @frat/react-native-admob

**Yarn:**

    yarn add @frat/react-native-admob@next
